...
- **Frontier capability layer (2026-06-14)**: in-browser LLM on WebGPU (`@mlc-ai/web-llm`) wired into NPC dialogue with cloud fallback; capability detection, "🧠 Local AI" demo panel, frontier legibility HUD (FPS/NPC/backend/"no server"), OPFS local save, canvas clip export. See `docs/web-frontier-prd.md`. In-browser behavior needs a real-device check.
