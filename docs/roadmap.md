...
- `docs/experiments/image-to-3d-bakeoff.md` — TRELLIS vs Hunyuan3D-2. Verdict
  defer; OSS rigging gap is the actual blocker.
- `docs/experiments/sadtalker-dialogue.md` — unblocked, sample MP4 generated.
  Verdict skip; SadTalker face-crop destroys per-NPC visual identity.
- `docs/experiments/vrm-baseline.md` — Playwright snapshot of live state.
- `docs/research/game-mechanics-audit.md` — full survey of AAA RPG basic
...
Each one is in `docs/research/game-mechanics-audit.md` with effort estimates.
