...
- Input portrait: [`web3d/public/assets/portraits/opm-z-city-mira.png`](../../web3d/public/assets/portraits/opm-z-city-mira.png) (this file is labelled "mira" — the audio script is Saitama-flavoured regardless; same portrait used as in the prior spike for direct comparability)
- Generated audio: [`tmp/experiments/saitama-voice.wav`](../../tmp/experiments/saitama-voice.wav) (3.0s, 263KB)
- Generated video: [`tmp/experiments/saitama-talking.mp4`](../../tmp/experiments/saitama-talking.mp4) (3.0s, 65KB, 256×256 H.264 + AAC)
