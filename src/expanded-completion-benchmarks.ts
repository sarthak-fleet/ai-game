...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/three/world-scene.ts", ["Raycaster", "onLocationSelect", "onNpcSelect", "onItemSelect", "onPropSelect", "onTargetHover", "onContextStatus", "webglcontextlost", "webglcontextrestored", "orbitCamera", "zoomCamera", "cameraZoomPercent", "resetCamera", "TRAVEL_ANIMATION_MS", "previousActorPositions", "movingActors", "actorMotion", "animateTravel", "makeTargetHalo", "sceneAnimation", "makePathMesh", "makeLabelSprite", "makeActorNameplate", "actor-nameplate", "makeLandmarkMesh", "reef_spire", "sonar_dish", "makePropMesh", "makeAtmosphereMesh", "atmosphereKindFor", "locationPalette", "actorBodyShapeFor", "makeActorAccessoryMesh", "bodyShape", "accentColor", "npc.id !== world.player.characterId", "SceneMoodNode", "sceneMoodForClock", "applySceneMood", "timeOfDay", "PCFSoftShadowMap", "applyShadows"]),
    ...
    gate(rootDir, "generic_world_ingest", "Generic world ingest", [
      ...
      source("src/anime-ingest.ts", ["locationPaletteFor", "locationLandmarksFor", "generatedPortraitDataUri", "data:image/svg+xml", "visualTags", "greenhouse|botanical", "cloud|sky|harbor", "sonar|hydrophone", "reef|coral", "reef_spire", "sonar_dish"]),
    ...
    gate(rootDir, "verification_surface", "Everything tested", [
      ...
      source("package.json", ["node scripts/copy-web-assets.mjs", "playtest:production"]),
      source("tests/playtests/production-build.ts", ["WEB_ROOT", "dist/web", "REQUIRED_ASSETS", "/assets/cc0/russpuppy/open_tileset_16.png", "/assets/cutscenes/ashbend_intro_square.mp4", "production 3D canvas should render nonblank pixels", "production agent step should visibly update 3D scene", "production mobile 3D canvas should render nonblank pixels", "01-production-3d.png", "02-production-mobile.png"]),
