...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/three/world-scene.ts", ["Raycaster", "onLocationSelect", "onNpcSelect", "onItemSelect", "onPropSelect", "onTargetHover", "orbitCamera", "resetCamera", "TRAVEL_ANIMATION_MS", "animateTravel", "makeTargetHalo", "sceneAnimation", "makePathMesh", "makeLabelSprite", "makeLandmarkMesh", "makePropMesh", "locationPalette"]),
      source("web/src/organisms/ThreeWorld.tsx", ["3D travel", "3D target", "3D camera controls", "Rotate camera right", "Reset camera", "onKeyDown", "keyboardDestinationFor", "hoverTarget", "movePlayerToward", "openDrawer", "pickup", "inspect", "ashbend:travel-to"]),
