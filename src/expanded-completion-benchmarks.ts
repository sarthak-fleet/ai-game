...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/three/world-scene.ts", ["Raycaster", "onLocationSelect", "onNpcSelect", "onItemSelect", "onPropSelect", "onTargetHover", "orbitCamera", "resetCamera", "makePathMesh", "makeLabelSprite", "makeLandmarkMesh", "makePropMesh", "locationPalette"]),
      source("web/src/organisms/ThreeWorld.tsx", ["3D travel", "3D target", "3D camera controls", "Rotate camera right", "Reset camera", "hoverTarget", "movePlayerToward", "openDrawer", "pickup", "inspect", "ashbend:travel-to"]),
      source("web/src/world-travel.ts", ["movePlayerToward", "shortestLocationRoute"]),
      source("tests/playtests/alive-village.ts", ["three-host canvas", "nonBlankCanvasPixels", "canvasPixelHash", "Rotate camera right", "Reset camera", "Go Herb Garden", "At Herb Garden", "Talk Mira", "dialogue-panel", "toHaveClass(/active/)", "expectNoVerticalOverlap"]),
