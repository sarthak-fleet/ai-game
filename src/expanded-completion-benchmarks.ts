...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/three/world-scene.ts", ["Raycaster", "onLocationSelect", "onNpcSelect", "onItemSelect", "onPropSelect", "onTargetHover", "onContextStatus", "webglcontextlost", "webglcontextrestored", "orbitCamera", "zoomCamera", "cameraZoomPercent", "resetCamera", "TRAVEL_ANIMATION_MS", "previousActorPositions", "movingActors", "actorMotion", "animateTravel", "makeTargetHalo", "sceneAnimation", "makePathMesh", "makeLabelSprite", "makeActorNameplate", "actor-nameplate", "makeLandmarkMesh", "reef_spire", "sonar_dish", "neon_sign", "rain_lamp", "evidence_board", "transformer_stack", "makePropMesh", "makeAtmosphereMesh", "atmosphereKindFor", "locationPalette", "actorBodyShapeFor", "makeActorAccessoryMesh", "bodyShape", "accentColor", "npc.id !== world.player.characterId", "SceneMoodNode", "sceneMoodForClock", "applySceneMood", "timeOfDay", "PCFSoftShadowMap", "applyShadows"]),
      source("web/src/organisms/ThreeWorld.tsx", ["3D travel", "3D target", "3D camera controls", "3D camera zoom", "Zoom camera in", "Zoom camera out", "3D agent activity", "3D renderer status", "latestAutonomousActivity", "action.type === \"move\"", "Rotate camera right", "Reset camera", "onKeyDown", "keyboardDestinationFor", "keyboardTargetFor", "hoverTarget ?? keyboardTargetFor", "activateSceneTarget", "event.key.toLowerCase() === \"e\"", "three-interact-button", "Interact with", "movePlayerToward", "openDrawer", "pickup", "inspect", "ashment:travel-to"]),
      ...
      source("tests/three-world.test.ts", ["structureColor", "landmarks", "forge_tool_rack", "objectives[0]", "moves the primary 3D objective beacon", "chosen character as the 3D player avatar", "bodyShape: \"broad\"", "bodyShape: \"caped\"", "bodyShape: \"mechanical\"", "changes 3D lighting mood with the world clock", "fogDensity", "atmosphere", "firefly", "dust", "source-derived artifact visuals", "source-derived location palettes", "conservatory-source.json", "abyssal-source.json", "noir-source.json", "reef_spire", "sonar_dish", "neon_sign", "rain_lamp", "evidence_board", "transformer_stack", "shape: \"gear\"", "shape: \"scrap\""]),
    ...
    gate(rootDir, "long_running_agents", "Long-running AI agents", [
      ...
      source("web/style.css", [".dialogue-mode > header", "max-height: min(480px, calc(100vh - 240px))", ".dialogue-mode .dialogue-panel", "z-index: 55"]),
    ...
    gate(rootDir, "verification_surface", "Everything tested", [
      ...
      source("tests/playtests/production-build.ts", ["WEB_ROOT", "dist/web", "dist/server/server.js", "REQUIRED_ASSETS", "/assets/cc0/russpuppy/open_tileset_16.png", "/assets/cutscenes/ashment_intro_square.mp4", "production 3D canvas should render nonblank pixels", "production agent step should visibly update 3D scene", "villageStartHash", "Neon Nocturne Playable Slice", "Recover Witness badge for Reva", "production imported noir 3D canvas should render nonblank pixels", "production noir 3D canvas should visually differ from village", "Neon Nocturne: World Ingest Slice", "03-production-noir-import.png", "production mobile imported 3D canvas should render nonblank pixels", "01-production-3d.png", "02-production-mobile.png"]),
