...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("tests/playtests/first-loop.ts", ["Slot Save", "page.reload", "hoverThreeTarget", "keyboard.press(\"e\")", "Bring Pruning shears to Mira", "Inspect Sooty tool rack", "Fresh soot outlines", "importInvalidSave", "Restore failed: Save file is not valid JSON", "Slot Load", "three-host canvas", "At Herb Garden"]),
    ...
    gate(rootDir, "long_running_agents", "Long-running AI agents", [
      ...
      source("web/style.css", [".dialogue-mode > header", "max-height: min(480px, calc(100vh - 240px))", ".dialogue-mode .dialogue-panel", ".objective-tracker", "z-index: 45"]),
