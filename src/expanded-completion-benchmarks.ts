...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/three/world-scene.ts", ["Raycaster", "onLocationSelect", "onNpcSelect", "onItemSelect", "onPropSelect", "onTargetHover", "orbitCamera", "resetCamera", "TRAVEL_ANIMATION_MS", "previousActorPositions", "movingActors", "actorMotion", "animateTravel", "makeTargetHalo", "sceneAnimation", "makePathMesh", "makeLabelSprite", "makeLandmarkMesh", "makePropMesh", "locationPalette"]),
      source("web/src/organisms/ThreeWorld.tsx", ["3D travel", "3D target", "3D camera controls", "3D agent activity", "latestAutonomousActivity", "action.type === \"move\"", "Rotate camera right", "Reset camera", "onKeyDown", "keyboardDestinationFor", "hoverTarget", "movePlayerToward", "openDrawer", "pickup", "inspect", "ashbend:travel-to"]),
      ...
      source("tests/playtests/alive-village.ts", ["three-host canvas", "nonBlankCanvasPixels", "canvasPixelHash", "travelStartHash", "Rotate camera right", "Reset camera", "keyboard.press(\"d\")", "keyboard.press(\"a\")", "Go Herb Garden", "At Herb Garden", "Talk Mira", "dialogue-panel", "toHaveClass(/active/)", "expectNoVerticalOverlap"]),
      source("tests/three-world.test.ts", ["structureColor", "landmarks", "forge_tool_rack"]),
