...
const base = JSON.parse(readFileSync(new URL("../worlds/one-punch-man.json", import.meta.url), "utf8")) as World;
...
describe("web3d tension mood", () => {
  it("computes world pressure from director state, tensions, and villain plans", () => {
    ...
    world.villainPlans = [{ id: "v", actorId: "x", title: "v", objective: "o", stage: 1, hidden: true, pressure: 72 }];
